...
class HomeViewModel: ObservableObject {
    ...
    enum SortOption { case rank, rankReversed, holdings, holdingsReversed, price, priceReversed }
    ...
    private func mapGlobalMarketData(marketData: MarketData?, portfolioCoins: [Coin]) -> [Statistic] {
        ...
        let portfolioPercentChange = ((portfolioValue - previousValue) / previousValue) * 100
        
        let portfolio = Statistic(title: "Portfolio Value", value: "\(portfolioValue.asCurrencyWith2Decimals())", percentageChange: portfolioPercentChange)
